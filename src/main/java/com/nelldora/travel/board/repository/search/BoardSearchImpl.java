...
public class BoardSearchImpl extends QuerydslRepositorySupport implements BoardSearch {
    ...
    @Override
    public Page<Board> searchList(PageBoardRequestDTO pageBoardRequestDTO) {

        QBoard board = QBoard.board;

        JPQLQuery<Board> query = from(board).where(likeBoardTitle(pageBoardRequestDTO.getSearchTitle()));


        Pageable pageable = PageRequest.of(
                pageBoardRequestDTO.getPage()-1,
                pageBoardRequestDTO.getSize(),
